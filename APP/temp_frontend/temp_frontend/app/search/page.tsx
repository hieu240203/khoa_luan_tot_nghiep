...
//   // Chuyển chuỗi thành số, và bỏ dấu chấm trước khi parseInt
...
//     // Khi load SearchPage, luôn gọi tìm kiếm
//     handleSearch({
...
//   // Khi keyword hoặc city thay đổi thì tự động tìm kiếm
//   useEffect(() => {
//     if (keyword || city || selectedCategories.length > 0) {
//       handleSearch();
//     }
//     fetchFavorites();
//   }, [keyword, city, selectedCategories, sortBy]);
...
//                   {/* Đưa Khoảng giá và Giờ mở cửa lên cùng một hàng */}
